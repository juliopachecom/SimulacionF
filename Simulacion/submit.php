				...
				<div class="row">
					<div class="col-md-12 texto">
						<div style="margin:5px;">
							<span style="font-size:18px;"><strong style="!important;">Simulaciones:</strong> '.$dif.'</span><br>
							<span style="font-size:18px;"><strong style=" !important;">Veces que se habilitó la vía alterna:</strong> '.$contvia.'</span>
						</div>
					</div>
				</div>
			</div>
